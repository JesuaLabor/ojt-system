                            ...
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan="4" className="text-center py-12 text-slate-500">
                                        ...
                                        <p className="text-sm font-medium">No partner companies found.</p>
                                    </td>
                                </tr>
                            ) : (
                                companies.map(c => (
                                    <tr key={c.id} className="hover:bg-slate-800/40 transition">
                                        ...
                                        <td>
                                            <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${c.status === 'active' ? 'bg-emerald-500/15 text-emerald-400' : 'bg-slate-500/15 text-slate-400'}`}>
                                                {c.status}
                                            </span>
                                        </td>
