...
function StatusBadge({ status }) {
    ...
    return (
        <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-bold uppercase tracking-wide ${cls}`}>
            <span className="text-[10px]">{icon}</span>{status}
        </span>
    )
}
...
export default function FacultyStudents() {
    ...
    useEffect(() => { fetchStudents() }, [selectedCompany])
    useEffect(() => {
        ...
        <div className="fade-in space-y-6 max-w-7xl pb-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="page-sub mt-1">OJT students in your department.</p>
                </div>
                <div className="relative w-full sm:w-72">
                    ...
                    <input
                        type="text"
                        placeholder="Search students or company…"
                        value={searchQuery}
            ...
            {summary && (
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                    ...
                    <div
                        ...
                        onClick={() => setEvalFilter(p => p === 'evaluated' ? '' : 'evaluated')}
                    >
                    ...
                    <div
                        ...
                        onClick={() => setEvalFilter(p => p === 'pending' ? '' : 'pending')}
                    >
                        <p className="text-lg mb-0.5">○</p>
                                        ...
                                        <tr key={student.student_id} className="table-row group">
                                            ...
                                            <td className="table-cell">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="min-w-0">
                                                        ...
                                                        <p className="text-xs text-slate-500 truncate">{student.department_name || '—'}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td className="table-cell">
                                                ...
                                                {student.supervisor_name && (
                                                    <p className="text-[11px] text-slate-500 mt-0.5 truncate">{student.supervisor_name}</p>
                                                )}
                                            </td>
                                            ...
                                            <td className="table-cell text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    <button
                                                        onClick={() => navigate(`/faculty/reports?student=${student.student_id}`)}
                                                        className="btn btn-sm btn-ghost text-xs"
                                                    >
                                                        Report
                                                    </button>
                                                    <button
                                                        onClick={() => navigate(`/faculty/evaluations?student=${student.student_id}`)}
